...
class App extends Component {
  ...
  onClickVisit = country => {
    ...
    const updatedData = countriesList.filter(
      eachCountry => eachCountry.id !== country.id,
    )
    const newCountry = {
      id: country.id,
      name: country.name,
    ...
    this.setState(prevState => ({
      ...
      countriesList: [...updatedData, newCountry],
    }))
  }

  onClickRemove = country => {
    ...
    const updatedVisitedCountiesList = visitedCountriesList.filter(
      eachCountry => eachCountry.id !== country.id,
    )
    this.setState({
      countriesList: [...updatedCountriesList, newCountry],
      visitedCountriesList: updatedVisitedCountiesList,
    })
  }
